...
export const fetchUsers = async (params?: { active?: boolean; vip?: boolean }): Promise<User[]> => {
...
export const updateUser = (id: number, data: { first_name?: string; last_name?: string; username?: string; language?: string; is_active?: boolean; is_vip?: boolean }) =>
